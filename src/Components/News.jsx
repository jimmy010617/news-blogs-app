...
import './News.css'
import userImg from '../assets/images/JimmyCha.jpg'
...
const News = ({ onShowBlogs, blogs, onEditBlog, onDeleteBlog }) => {
	...
	const NEWS_API_KEY = import.meta.env.VITE_NEWS_API_KEY
        ...
        const fetchNews = async () => {
            ...
            const savedBookmarks = JSON.parse(localStorage.
            getItem('bookmarks')) || []
    ...
    const handleBookmarkClick = (article) => {
        setBookmarks((prevBookmarks) => {
            ...
            ((bookmark) => bookmark.title === article.title) ?
                prevBookmarks.filter((bookmark) => bookmark.
                title !== article.title)
    ...
    return (
        <div className='news'>
                ...
                <div className="search-bar">
                    <form onSubmit={handleSearch}>
                        <input 
                            ...
                            value={searchInput} 
                            onChange={(e) => setSearchInput(e.target.
                            value)}
                        />
                        <button type='submit'>
            ...
            <div className="news-content">
                    ...
                    <nav className="categories">
                        ...
                        <div className="nav-links">
                            ...
                            setShowBookmarksModal(true)}>
                                Bookmarks <i className="fa-solid
                                fa-bookmark"></i>
                            </a>
                        </div>
                    </nav>
                ...
                <NewsModal show={showModal} article={selectedArticle} onClose={() => setShowModal
                (false)} />
                <Bookmarks 
                ...
                <div className="my-blogs">
                    ...
                    <div className="blog-posts">
                        {blogs.map((blog, index) => (
                            <div key={index} className="blog-post" onClick=
                    ...
                    {selectedPost && showBlogModal && (
                        ...
                        {selectedPost} onClose={closedBlogModal} />
                    )}
                </div>
            ...
            <footer className="news-footer">
                ...
                <p>&copy; All Right Reserved. By Jimmy Cha</p>
            </footer>
        </div>
    )
}
